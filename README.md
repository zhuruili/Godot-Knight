...
希望能通过记录开发过程来激励自己跟进教程的学习，本仓库仅包含制作游戏需要的代码文件，游戏本体（Windows）发布在`Releases`中，可下载游玩
...
将部分游戏效果图合成为`GIF`图展示如下，这并非游戏的完整内容，只是一小部分战斗切片

![游戏部分效果合订版动图展示](GameScreenshots/合订版动图展示.gif)
...
游戏制作全流程已完结，制作过程中留下的简易笔记在`Docs`文件夹下，仅记录一些关键知识点
...
- [X] [Chapter25](Docs/Chapter25.md)：游戏导出
